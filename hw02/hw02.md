...
![](hw02_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-27-1.png) The mean GDP per capita for each country is shown by the pink point on the plot.
...
|   2007   |     Iceland    |                                                                                                 81.76                                                                                                |
| From thi | s table we can | see that over time the minimum life expectantcy in Europe has gone up with Norway having the lowest life expectantcy (72.67) in 1952 and Iceland having the lowest life expectantcy (81.76) in 2007. |
