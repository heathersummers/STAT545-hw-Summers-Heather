...
ggplot(data.long,aes(x = year, y = lifeExp, colour = country)) +
  ...
  theme(axis.title = element_text(size=14, face="bold"),
        plot.title = element_text(size=16, hjust=0.48),
        axis.title.x = element_text(size=13),
        axis.title.y = element_text(size=13),
        legend.title = element_text(size=14, face="bold"),
        legend.text = element_text(size=13)) +
  labs(x = "Year", y = "Life Expectancy (Year)", title = "Comparison of Life Expectancies of Canada, New Zealand, France, Belgium, and Denmark")
```
